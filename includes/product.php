...
class Product extends DatabaseObject{
    ...
    protected static $db_fields = array('id' , 'name' , 'filename' ,'description','price', 'type' );
    public $id ;
    public $name ; 
    public $filename ;
    public $description ;
    ...
    private $temp_path;
    protected $upload_dir="product_images" ;
    public $errors = array();
    ...
    public function productCategory(){
            if(isset($this->type)){
            $sql = "select type from product_type where id = ".$this->type ;
            global $database ;
